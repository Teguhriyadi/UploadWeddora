                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <select name="relasi" class="form-control @error('relasi') is-invalid @enderror"
                                    ...
                                    <option {{ old('Saudara') == "Saudara" ? 'selected' : '' }} value="Saudara">Saudara</option>
                                    <option {{ old('Teman Kerja') == "Teman Kerja" ? 'selected' : '' }} value="Teman Kerja">Teman Kerja</option>
                                    <option {{ old('Teman SMA') == "Teman SMA" ? 'selected' : '' }} value="Teman SMA">Teman SMA</option>
                                    <option {{ old('Relasi Ortu') == "Relasi Ortu" ? 'selected' : '' }} value="Relasi Ortu">Relasi Ortu</option>
                                    <option {{ old('Teman Kuliah') == "Teman Kuliah" ? 'selected' : '' }} value="Teman Kuliah">Teman Kuliah</option>
                                    <option {{ old('Atasan') == "Atasan" ? 'selected' : '' }} value="Atasan">Atasan</option>
                                </select>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <select name="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
                                    id="keterangan">
                                    <option value="">- Pilih -</option>
                                    <option {{ old('keterangan') == 'CPP' ? 'selected' : '' }} value="CPW">CPW</option>
                                    <option {{ old('keterangan') == 'CPW' ? 'selected' : '' }} value="CPP">CPP</option>
                                </select>
