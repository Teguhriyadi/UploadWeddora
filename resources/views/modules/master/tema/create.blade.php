    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <form action="{{ url('/modules/landing-page/tema') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="mb-3 row">
                                ...
                                <select name="lp_kategori_id"
                                    ...
                                    @foreach ($kategori as $item)
                                        <option value="{{ $item['id'] }}"
                                            {{ old('lp_kategori_id') == $item['id'] ? 'selected' : '' }}>
                                            {{ $item['nama_kategori'] }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" rows="5" placeholder="Masukkan Deskripsi">{{ old('deskripsi') }}</textarea>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control @error('badge') is-invalid @enderror"
                                    id="badge" name="badge" placeholder="Masukkan Badge" value="{{ old('badge') }}">
                        ...
                        <div class="mb-3 row">
                            <label for="img_bg" class="col-sm-2 col-form-label">
                                Gambar Background
                                <span class="text-danger">*</span>
                            </label>
                            <div class="col-sm-6">
                                <input type="file" class="form-control @error('img_bg') is-invalid @enderror"
                                    id="img_bg" name="img_bg">
