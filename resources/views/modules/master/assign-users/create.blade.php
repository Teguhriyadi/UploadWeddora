    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <form action="{{ url('/modules/assign-users') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <select name="jabatan"
                                    ...
                                    <option {{ old('jabatan') == "CUSTOMER" ? 'selected' : '' }} value="CUSTOMER">CUSTOMER</option>
                                    <option {{ old('jabatan') == "PJ" ? 'selected' : '' }} value="PJ">PJ</option>
                                    <option {{ old('jabatan') == "PETUGAS" ? 'selected' : '' }} value="PETUGAS">PETUGAS</option>
                                </select>
