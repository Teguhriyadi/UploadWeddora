    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <form action="{{ url('/modules/event/' . $edit['id']) }}" method="POST">
                    @csrf
                    @method("PUT")
                    <div class="card-body">
                        <div class="mb-3 row">
                                ...
                                <select name="cabang_id"
                                    ...
                                    @foreach ($cabang as $item)
                                        <option value="{{ $item['id'] }}"
                                            {{ old('cabang_id', $edit['cabang_id']) == $item['id'] ? 'selected' : '' }}>
                                            {{ $item['nama'] }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control @error('nama_cpp') is-invalid @enderror"
                                    ...
                                    value="{{ old('nama_cpp', $edit['nama_cpp']) }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control @error('nama_cpw') is-invalid @enderror"
                                    ...
                                    value="{{ old('nama_cpw', $edit['nama_cpw']) }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control @error('nama_event') is-invalid @enderror" name="nama_event" id="nama_event" placeholder="Masukkan Nama Event" value="{{ old('nama_event', $edit['nama_event']) }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-3">
                                <input type="datetime-local" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal" name="tanggal" value="{{ old('tanggal', $edit['tanggal']) }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control @error('lokasi') is-invalid @enderror" name="lokasi" id="lokasi" value="{{ old('lokasi', $edit['lokasi']) }}" placeholder="Masukkan Lokasi">
